...
export const Navigation = () => {
    return (
        <div className="flex gap-4 bg-[#2d6db6]  fixed left-0 top-0 w-full justify-center text-3xl p-1 shadow-[0_0_15px_#facc15]">
            <img src={logo} alt="Logo" className="w-13 h-13 fixed left-1 top-0" />
